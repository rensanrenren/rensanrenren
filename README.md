...
[![My Skills](https://skillicons.dev/icons?i=js,threejs,nodejs,nextjs,react,html,css,ts,py,flask,webpack,ros,linux,docker,vite,vscode,atom,arduino,npm,blender,xd,ps,ai,figma,notion)](https://skillicons.dev)
